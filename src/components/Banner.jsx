...
const Banner = () => {
    return (
        <div className='container flex justify-center mt-16 rounded'>
            <section className="bg-gray-100 w-[80em]">
                <div className="container mx-auto text-center">
                    <div className="grid grid-cols-1 md:grid-cols-3 ">
                        <div className="flex justify-center">
                            <img src={arrive1} alt="New Arrival 1" className="h-full w-full object-cover" />
                        </div>
                        <div className="flex flex-col items-center justify-between bg-white px-8">
                            <img src={arrive3} alt="arrive4" />
                            ...
                            <img src={arrive4} alt="arrive3" />
                        </div>
                        <div className="flex justify-center">
                            <img src={arrive2} alt="New Arrival 2" className="h-full w-full object-cover" />
                        </div>
                    </div>
                </div>
            </section>
