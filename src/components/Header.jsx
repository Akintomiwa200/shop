      ...
      <div className="bg-white w-full lg:w-[80em] h-[9em]">
        <div className="mx-auto flex items-center justify-between py-4 px-6">
          ...
          <div className="hidden lg:flex space-x-4">
            <Link to="/" className="text-gray-700 border border-blue-600 hover:text-blue-600 px-4 py-2 rounded">Log in</Link>
            <Link to="/" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Get started</Link>
          </div>
